...
public class SortChemicals extends javax.swing.JFrame {
    ...
    private static String[] chemicalNames;
    ...
    public SortChemicals(DatabaseGUI databaseGUI) {
        ...
        if (chemicalNames == null) {
            ...
            this.selectedProperty = new String();
        }
        initComponents();
    }
    ...
    private void jButtonSortActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSortActionPerformed
        ...
        chemicalNames = new String[chemicals.size()];
        for(int i = 0; i < chemicalNames.length; i++){
            chemicalNames[i] = chemicals.get(i).getCommonName();
        }
