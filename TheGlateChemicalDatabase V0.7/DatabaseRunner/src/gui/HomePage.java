...
public class HomePage extends javax.swing.JFrame {
    ...
    private void createTable(){
        ...
        this.numRow = this.databaseGUI.getDatabase().getPeriodicTable().getNumRow() - 1;
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
        if(this.databaseGUI.save(this.databaseGUI.getElementsFile(), this.databaseGUI.getBinaryCompoundsFile(), this.databaseGUI.getReactionsFile()))
