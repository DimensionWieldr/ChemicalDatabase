...
public class SimulateReaction extends javax.swing.JFrame {
    ...
    private void jButtonSubmitReactantsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSubmitReactantsActionPerformed
        ...
        if (tempChemical1 instanceof Element && tempChemical2 instanceof Element) {
            ...
            this.jLabelMolecularFormulaReactant1.setText(this.reactant1.getMolecularFormula());
            ...
            this.jLabelMolecularFormulaReactant2.setText(this.reactant2.getMolecularFormula());
            ...
            if (this.reaction.getID() == Reaction.getREPEATED_REACTION_ID()) {
                ...
                if (!this.sameReactants) {
                    //Product Formulas
                    this.jLabelProductA.setText(this.product.getComponent1().getComponent().getMolecularFormula());
                    this.jLabelProductB.setText(this.product.getComponent2().getComponent().getMolecularFormula());
                    this.jLabelEquationProductA.setText(this.product.getComponent1().getComponent().getMolecularFormula());
                    this.jLabelEquationProductB.setText(this.product.getComponent2().getComponent().getMolecularFormula());
                ...
                this.jLabelEquationReactant1.setText(this.reactant1.getMolecularFormula());
                this.jLabelEquationReactant2.setText(this.reactant2.getMolecularFormula());
