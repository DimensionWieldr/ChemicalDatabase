...
public class ReactionManager {
    ...
    public void removeReaction(Reaction reactionToBeRemoved) {
        reactionToBeRemoved.getReactant1().getReactionsInvolved().remove(reactionToBeRemoved);
        reactionToBeRemoved.getReactant2().getReactionsInvolved().remove(reactionToBeRemoved);
        reactionToBeRemoved.getProduct().getReactionsInvolved().remove(reactionToBeRemoved);
