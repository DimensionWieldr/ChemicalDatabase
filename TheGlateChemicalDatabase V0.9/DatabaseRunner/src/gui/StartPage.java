...
public class StartPage extends javax.swing.JFrame {
    ...
    private void jButtonSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSubmitActionPerformed
        ...
        if(elementsFileCheck == DatabaseGUI.VALID_FILE && binaryCompoundFileCheck == DatabaseGUI.VALID_FILE && reactionsFileCheck == DatabaseGUI.VALID_FILE) {
            elementsFile = elementsFile + DatabaseGUI.FILE_EXTENSION;
            binaryCompoundsFile = binaryCompoundsFile + DatabaseGUI.FILE_EXTENSION;
            reactionsFile = reactionsFile + DatabaseGUI.FILE_EXTENSION;
