...
public class ListBinaryCompounds extends javax.swing.JFrame {
    ...
    //our fields
    private static List<BinaryCompound> compounds;
    private static String[] names;
    
    /**
     * Creates new form ListBinaryCompounds
     */
    public ListBinaryCompounds() {
        createList();
        initComponents();
    }
    ...
    private static void createList(){
        compounds = DatabaseGUI.listBinaryCompounds();
        names = new String[compounds.size()];
        
        for(int i = 0; i < names.length; i++){
            names[i] = compounds.get(i).getCommonName();
        }
    }
    ...
    private void jButtonSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSearchActionPerformed
        ...
        Chemical search = DatabaseGUI.getDatabase().searchChemicalsByName(name);
    ...
    public static void start() {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListBinaryCompounds().setVisible(true);
            }
        });
    }
