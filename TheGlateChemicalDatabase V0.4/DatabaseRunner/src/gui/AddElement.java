...
public class AddElement extends javax.swing.JFrame {
    ...
    private void jButtonSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSubmitActionPerformed
        try{
            ...
            //create new Element and add it to the database, doing checks for valid properties
            Element newElement = new Element(name, stpDensity, molarMass, bp, mp, colour, numProton, numNeutron, ionizationEnergy, electronegativity, molecularFormula);
            
            if(name.equals(Chemical.getDEFAULT_COMMON_NAME()))
