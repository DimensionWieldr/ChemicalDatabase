...
public class ChemicalDatabase {
    ...
    protected static final String EMPTY_STRING = ""; //for user input checking purposes
    ...
    public boolean load(String elementsFile, String binaryCompoundsFile, String reactionsFile, int firstValence, int increment) {
        ...
        try {
            ...
            while((line = in.readLine()) != null){
                ...
                if (!line.equals(Chemical.NO_REACTIONS_INVOLVED)) {
                    ...
                    String[] tempIndexArray = line.split(" ");
                    ...
                    for (int i = 0 ; i < tempIndexArray.length ; i++){
                        ...
                        reactionsInvolvedIndices.get(i).setID(Integer.parseInt(tempIndexArray[i]));
                    }
        ...
        try{
            ...
            while((line = in.readLine()) != null){
                Reaction newReaction = new Reaction(Integer.parseInt(line), (Element)searchChemicalsByName(in.readLine()), (Element)searchChemicalsByName(in.readLine()));
        ...
        List<Reaction> tempReactionsInvolved;

        for (int i = 0 ; i < this.chemicals.size() ; i++) {
            tempReactionsInvolved = new ArrayList();
    ...
    public void removeReaction(int index){
        if(index >= 0){
            chemicals.remove(reactionManager.getReactionList().get(index).getProduct());
