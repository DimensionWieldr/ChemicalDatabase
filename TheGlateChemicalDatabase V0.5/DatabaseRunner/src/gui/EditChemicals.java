...
public class EditChemicals extends javax.swing.JFrame {

    //our fields
    private static Chemical search;
    
    /**
     * Creates new form EditChemicals
     */
    public EditChemicals() {
        initComponents();
    ...
    private void jButtonSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSubmitActionPerformed
        ...
        try {
            ...
            if(!this.jTextFieldStpDensity.getText().equals(ChemicalDatabase.getEMPTY_STRING())){
                stpDensity = Double.parseDouble(this.jTextFieldStpDensity.getText());
            }else
                stpDensity = Chemical.getDEFAULT_DENSITY();
            
            if(!this.jTextFieldBP.getText().equals(ChemicalDatabase.getEMPTY_STRING())){
                bp = Double.parseDouble(this.jTextFieldBP.getText());
            }else
                bp = Chemical.getDEFAULT_STATE_CHANGE_TEMP();
            
            if(!this.jTextFieldMP.getText().equals(ChemicalDatabase.getEMPTY_STRING())){
                mp = Double.parseDouble(this.jTextFieldMP.getText());
            }else
                mp = Chemical.getDEFAULT_STATE_CHANGE_TEMP();
            
            if(!this.jTextFieldColour.getText().equals(ChemicalDatabase.getEMPTY_STRING()))
            ...
            if(commonName.equals(ChemicalDatabase.getEMPTY_STRING()))
                ...
                if(search instanceof BinaryCompound){
                    
                    if(DatabaseGUI.editBinaryCompounds((BinaryCompound)search, commonName, stpDensity, bp, mp, colour)){
                    ...
                    //read optional fields
                    if(!jTextFieldNumNeutron.getText().equals(ChemicalDatabase.getEMPTY_STRING())){
                        numNeutron = Integer.parseInt(this.jTextFieldNumNeutron.getText());
                    }else
                        numNeutron = NuclearProperties.getDEFAULT_NEUTRONS();
                    
                    if(!this.jTextFieldMolarMass.getText().equals(ChemicalDatabase.getEMPTY_STRING())){
                        molarMass = Double.parseDouble(this.jTextFieldMolarMass.getText());
                    }else
                        molarMass = Chemical.getDEFAULT_MOLAR_MASS();
                    
                    if(!this.jTextFieldIonizationEnergy.getText().equals(ChemicalDatabase.getEMPTY_STRING())){
                    ...
                    if(molecularFormula.equals(ChemicalDatabase.getEMPTY_STRING()))
                        JOptionPane.showMessageDialog(null, "A required field is blank!");
                    ...
                    else if(DatabaseGUI.editElements((Element)search, commonName, stpDensity, bp, mp, colour, molecularFormula, numProton, electronegativity, numNeutron, molarMass, ionizationEnergy))
                        JOptionPane.showMessageDialog(null, "Edit successful!");
    ...
    private void jButtonSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSearchActionPerformed
        ...
        search = DatabaseGUI.getDatabase().searchChemicalsByName(name);
        ...
        if(search != null){
            ...
            if(search instanceof BinaryCompound){
                ...
                this.jLabelCommonName.setText("Name:");
                this.jTextFieldCommonName.setText(finalSearch.getCommonName());
                this.jLabelStpDensity.setText("Density @ STP (g/L):");
                this.jTextFieldStpDensity.setText("" + finalSearch.getStpDensity());
                this.jLabelBP.setText("Boiling Point (C):");
                this.jTextFieldBP.setText("" + finalSearch.getBP());
                this.jLabelMP.setText("Melting Point (C):");
                this.jTextFieldMP.setText("" + finalSearch.getMP());
                this.jLabelColour.setText("Colour:");
                this.jTextFieldColour.setText(finalSearch.getColour());

                this.jLabelMolecularFormula.setVisible(false);
                this.jTextFieldMolecularFormula.setVisible(false);
                this.jLabelMolarMass.setVisible(false);
                this.jTextFieldMolarMass.setVisible(false);
                this.jLabelNumProton.setVisible(false);
                this.jTextFieldNumProton.setVisible(false);
                this.jLabelNumNeutron.setVisible(false);
                this.jTextFieldNumNeutron.setVisible(false);
                this.jLabelIonizationEnergy.setVisible(false);
                this.jTextFieldIonizationEnergy.setVisible(false);
                this.jLabelElectronegativity.setVisible(false);
                this.jTextFieldElectronegativity.setVisible(false);
                
                this.setTextFieldsEnabled(true);

            } else if(search instanceof Element) {

                Element finalSearch = (Element)search;
                ...
                this.jLabelMolecularFormula.setText("Atomic Symbol:");
                this.jTextFieldMolecularFormula.setText(finalSearch.getMolecularFormula());
                this.jLabelMolarMass.setText("Molar Mass (g/mol):");
                this.jTextFieldMolarMass.setText("" + finalSearch.getMolarMass());
                this.jLabelNumProton.setText("Protons (Atomic #):");
                this.jTextFieldNumProton.setText("" + finalSearch.getNumProton());
                this.jLabelNumNeutron.setText("Neutrons:");
                this.jTextFieldNumNeutron.setText("" + finalSearch.getNumNeutron());
                this.jLabelIonizationEnergy.setText("Ionization Energy:");
                this.jTextFieldIonizationEnergy.setText("" + finalSearch.getNuclearProp().getIonizationEnergy());
                this.jLabelElectronegativity.setText("Electronegativity:");
                this.jTextFieldElectronegativity.setText("" + finalSearch.getNuclearProp().getElectronegativity());
    ...
    public static void start() {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditChemicals().setVisible(true);
            }
        });
    }
