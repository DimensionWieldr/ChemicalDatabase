...
public class HomePage extends javax.swing.JFrame implements WindowListener{
    ...
    private void createTable(){
        ...
        for(int i = 0; i < this.numRow; i++){
            for(int j = 0; j < this.databaseGUI.getDatabase().getPeriodicTable().getTable().get(i).numItems(); j++){
                this.table[i][j] = this.databaseGUI.getDatabase().getPeriodicTable().getTable().get(i).getPeriodElements()[j].getMolecularFormula();
                if(this.table[i][j].equals(Chemical.DEFAULT_MOLECULAR_FORMULA))
    ...
    private void jTablePeriodicTableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablePeriodicTableMousePressed
        ...
        if(selectedString != null){
            ...
            Element selectedElement = this.databaseGUI.searchElementByMolecularFormula(selectedString);
            ...
            if (selectedElement.getNumNeutron() == NuclearProperties.DEFAULT_NEUTRONS)
                this.jLabelNumNeutron.setText("Neutrons: " + Chemical.DEFAULT_COMMON_NAME);
            else
            ...
            if (selectedElement.getMolarMass() == Chemical.DEFAULT_MOLAR_MASS)
                this.jLabelMolarMass.setText("Molar Mass (g/mol): " + Chemical.DEFAULT_COMMON_NAME);
            else
                this.jLabelMolarMass.setText("Molar Mass (g/mol): " + selectedElement.getMolarMass());
            ...
            if (selectedElement.getStpDensity() == Chemical.DEFAULT_DENSITY)
                ...
                this.jLabelStpDensity.setText("Density @ STP (g/L): " + selectedElement.getStpDensity());
            ...
            if (selectedElement.getMP() == Chemical.DEFAULT_STATE_CHANGE_TEMP)
                ...
                this.jLabelMP.setText("Melting Point (C): " + selectedElement.getMP());
            ...
            if (selectedElement.getBP() == Chemical.DEFAULT_STATE_CHANGE_TEMP)
                ...
                this.jLabelBP.setText("Boiling Point (C): " + selectedElement.getBP());
            
            if (selectedElement.getIonizationEnergy() == NuclearProperties.DEFAULT_IONIZATION_ENERGY)
                this.jLabelIonizationEnergy.setText("First Ionization Energy: " + Chemical.DEFAULT_COMMON_NAME);
            else
    ...
    private void jButtonReloadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonReloadActionPerformed
        this.databaseGUI.savePrompt(false);
        this.databaseGUI = new DatabaseGUI();
        this.setVisible(false);
    }//GEN-LAST:event_jButtonReloadActionPerformed

    //Save button
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
        if(this.databaseGUI.save())
    ...
    public void start() {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HomePage(databaseGUI).setVisible(true);
            }
        });
    }
