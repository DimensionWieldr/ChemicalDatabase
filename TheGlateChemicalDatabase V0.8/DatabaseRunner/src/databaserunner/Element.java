...
public class Element extends Chemical {
    ...
    //start of NuclearProperties accessors & mutators//NUT//NUT//NUT//NUT//NUT//NUT//NUT//NUT//NUT//NUT//NUT//NUT//NUT//NUT
    ...
    public boolean setMolecularFormula(String atomicSymbol) {
        this.atomicSymbol = atomicSymbol;
        if (atomicSymbol.contains(DatabaseGUI.SPACE) || atomicSymbol.equals(DEFAULT_MOLECULAR_FORMULA)) 
            return false;
        return true;
    }
