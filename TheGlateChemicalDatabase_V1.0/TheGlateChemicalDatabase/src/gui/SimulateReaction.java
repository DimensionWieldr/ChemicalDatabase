...
public class SimulateReaction extends javax.swing.JFrame implements WindowListener{
    ...
    private void initConstants() {
        ...
        this.jLabelMolecularFormulaReactant1.setText(BinaryCompound.LABEL_ELEMENT_2);
    ...
    private void jButtonBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBackActionPerformed
        if(this.productInfoEntered || this.noProduct){
            ...
            JOptionPane.showMessageDialog(null, DatabaseGUI.WARNING_PRODUCT_INFO_ENTERED);
        }
    ...
    private void jButtonSubmitReactantsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSubmitReactantsActionPerformed
        ...
        System.out.println(DatabaseGUI.getMadeChanges());
