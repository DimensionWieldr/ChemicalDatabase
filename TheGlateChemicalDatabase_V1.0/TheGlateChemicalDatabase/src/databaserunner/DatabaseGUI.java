...
public class DatabaseGUI {
    ...
    public int savePrompt(boolean close) {
        if (madeChanges) {
            int optionNum = JOptionPane.showOptionDialog(null, DatabaseGUI.SAVE_PROMPT, DatabaseGUI.EMPTY_STRING, JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE, null, DatabaseGUI.ON_CLOSE_OPTIONS, null);
